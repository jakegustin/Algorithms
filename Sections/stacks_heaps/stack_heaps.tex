...
\begin{Central Processing Unit (CPU)}
...
\begin{Def}[Instructions]
    ...
    The CPU register (IP/EIP) is the \textbf{instruction pointer}, pointing to the next operation to execute. All commands are baked 
